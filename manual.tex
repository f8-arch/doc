...
There is an 8-bit flag register \texttt{f}, which contains the the overflow / parity flag \texttt{o}, the negative flag \texttt{n}, the zero flag \texttt{z}, the carry flag \texttt{c}, half-carry flag \texttt{h}, and three reserved bits. Unless otherwise noted, instructions leave the reserved flags in an undefined state. The reserved bits should not be written by the user except via the \texttt{xch f, (}n\texttt{, sp)} instruction.
...
\begin{bytefield}[bitwidth=0.050\linewidth]{8}
	\bitheader{0,7} \\
	\bitbox{1}{\texttt{o}} & \bitbox{1}{\texttt{n}} & \bitbox{1}{\texttt{z}} & \bitbox{1}{\texttt{c}} & \bitbox{1}{\texttt{h}} & \bitbox{3}{reserved}
\end{bytefield}
...
Instructions where the same location is used for \texttt{altacc8} and \texttt{op8\_2} operand are not valid.
...
none (\texttt{addw sp, \#d}) or \texttt{onzc} (all others).
...
\texttt{nzc} (\texttt{sllw y} and \texttt{sllw altacc16}) or \texttt{nz} (others).
...
\hline
3x & subw y, mm & ldw y, sp & subw y, (n, sp) & subw y, x & sbcw y, mm & ldw ((n,sp)), y & sbcw y, (n, sp) & sbcw y, x & addw y, mm & inc (n, sp) & addw y, (n, sp) & addw y, x & adcw y, mm & adcw y, \#ii & adcw y, (n, sp) & adcw y, x \\
\hline
4x & sllw y &  & rrcw y & altacc3 & sllw y, xl & sraw y & rrcw (n, sp) & rlcw (n, sp) & jrno \#d & altacc5 & jrsge \#d & jrslt \#d & jrsle \#d &  & ldw x, (y) & jrle \#d \\
\hline
5x & addw y, \#ii & inc mm & inc xl & inc (n, y) & dec (n, sp) & dec mm & dec xl & dec (n, y) & rrc (n, sp) & rrc mm & rrc xl & rrc (n, y) & rlc (n, sp) & rlc mm & rlc xl & rlc (n, y) \\
\hline
6x & push (n, sp) & push mm & push xl & push (n, y) & jp y & jp \#ii & call \#ii & call y &  & srlw y &  &  &  &  & ldw y, z &  \\
\hline
...
\hline
8x & pushw (n, sp) & pushw mm & pushw (nn, z) & pushw y & tstw (n, sp) & tstw mm & tstw (nn, z) & tstw y & ldw (n, y), x & pushw \#ii & addw sp, \#d & addw y, \#d & ldi (n, y), (z) & ldwi (n, y), (z) & sex y, xl & zex y, xl \\
\hline
...
\hline
ax & xch xl, (n, sp) & push \#i & xch xl, (y) & xch yl, yh & incw (n, sp) & incw mm & sbcw (nn, z) & incw y & adcw (n, sp) & adcw mm & adcw (nn, z) & adcw y & sbcw (n, sp) & sbcw mm & incw (nn, z) & sbcw y \\
\hline
...
\hline
cx & ld xl, mm & bool xl & ld xl, (n, sp) & ld xl, (nn, z) & ld xl, (n, y) & ld xl, (y) & ld xl, xh & ld xl, yl & ld xl, zl & ld xl, yh & ld xl, zh & ld mm, xl & ld (nn, z), xl & ld (n, sp), xl & ld (y), xl & ld (n, y), xl \\
\hline
...
\hline
ex & orw y, mm & orw y, \#ii & orw y, (n, sp) & orw y, x & xchw y, (n, sp) & xchw x, (y) & incnw y & decw (n, sp) & pop xl & ld xl, \#i & dnjnz yh, \#d & cax (y), zl, xl & altacc1 & ldw mm, y & altacc2 & rlcw y \\
\hline
