...
\hline\hline
0x & trap & sub xl, mm & sub xl (nn, z) & sub xl (n, sp) & xor xl, yh & xor xl, xh & xor xl, \#i & xor xl, yl & sbc xl, zl & sbc xl, mm & sbc xl (nn, z) & sbc xl (n, sp) & sbc xl, yh & sbc xl, xh &  & sbc xl, yl \\
\hline
1x & jrc \#d & cpw y, \#ii & jrnz \#d & jrz \#d & ldw (y), x & jrnc \#d & jr \#d & jrn \#d & ldw y, z & jrno \#d & jrslt \#d & jrsge \#d & jrle \#d & jrsle \#d & altacc5 & ldw x, (y) \\
\hline
2x & cp xl, zl & cp xl, mm & cp xl (nn, z) & cp xl (n, sp) & cp xl, yh & cp xl, xh & cp xl, \#i & cp xl, yl & or xl, zl & or xl, mm & or xl (nn, z) & or xl (n, sp) & or xl, yh & or xl, xh & or xl, \#i & or xl, yl \\
\hline
3x & and xl, zl & and xl, mm & and xl (nn, z) & and xl (n, sp) & and xl, yh & and xl, xh & altacc1 & and xl, yl & xor xl, zl & xor xl, mm & xor xl (nn, z) & xor xl (n, sp) & sub xl, yh & ld xl, yl & sub xl, zl & sub xl, yl \\
\hline
4x & sll mm & srl (n, sp) & srl (n, y) & srl xl & sll (n, y) & sll (n, sp) & srl mm & sll xl & tst mm & crl (n, sp) & crl (n, y) & crl xl & tst (n, y) & tst (n, sp) & crl mm & tst xl \\
\hline
5x & ld xl, (y) & ld xl, mm & ld xl, (nn, z) & ld xl, (n, sp) & sub xl, xh & ld xl, (n, y) & ld xl, \#i & ld xl, xh & ld (n, sp), xl & ld xl, zl & ld mm, xl & ld xl, zh & ld (n, y), xl & ld (nn, z), xl & ld xl, yh & ld (y), xl \\
\hline
6x & jp \#ii & push (n, sp) & push (n, y) & push xl & call y & jp y & push mm & call \#ii &  &  &  &  &  &  &  &  \\
\hline
7x & ldw ((n,sp)), y & subw y, mm & subw y, x & subw y, (n, sp) & sbcw y, x & sbcw y, mm & ldw y, sp & sbcw y, (n, sp) & adcw y, \#ii & addw y, mm & addw y, x & addw y, (n, sp) & adcw y, x & adcw y, mm & inc (n, sp) & adcw y, (n, sp) \\
\hline
8x & dec mm & addw y, \#ii & inc (n, y) & inc xl & dec (n, y) & dec (n, sp) & inc mm & dec xl & rlc mm & rrc (n, sp) & rrc (n, y) & rrc xl & rlc (n, y) & rlc (n, sp) & rrc mm & rlc xl \\
\hline
9x & ldw y, (n, y) & ldwy, mm & ldw y, (nn, z) & ldw y, (n, sp) & ldw y, \#d & ldw y, (y) & ldw y, \#ii & ldw y, x & ldw z, y & ldw (n, sp), y & ldw x, y & ldw (nn, z), y & ldwi (n, y), (z) & jrnn \#d & ldw mm, y & ldw (n, y), x \\
\hline
10x & incw mm & clrw (n, sp) & clrw y & clrw (nn, z) & incw y & incw (n, sp) & clrw mm & incw (nn, z) & sbcw mm & adcw (n, sp) & adcw y & adcw (nn, z) & sbcw y & sbcw (n, sp) & adcw mm & sbcw (nn, z) \\
\hline
11x & altacc4 & xch xl, (n, sp) & xch yl, yh & xch xl, (y) & da xl & rot xl, \#i & push \#i & sra xl & swapop & pop xl & cax (y), zl, xl & thrd xl & rlcw (n, sp) & and xl, \#i & bool xl & altacc2 \\
\hline
12x & tstw mm & pushw (n, sp) & pushw y & pushw (nn, z) & tstw y & tstw (n, sp) & pushw mm & tstw (nn, z) & xch f, (n, sp) & popw y & addw y, \#d & addw sp, \#d & zex y, xl & ldi (n, y), (z) & pushw \#ii & sex y, xl \\
\hline
13x & add xl, zl & add xl, mm & add xl (nn, z) & add xl (n, sp) & add xl, yh & add xl, xh & add xl, \#i & add xl, yl & adc xl, zl & adc xl, mm & adc xl (nn, z) & adc xl (n, sp) & adc xl, yh & adc xl, xh & adc xl, \#i & adc xl, yl \\
\hline
14x & sraw y & sllw y & rlcw y & rrcw y & altacc3 & sllw y, xl & srlw y & rrcw (n, sp) & mad x, mm, yl & mul y & reti & ret & mad x, (z), yl & negw y & msk (y), xl, \#i & mad x, (nn, z), yl \\
\hline
15x & xchw x, (y) & orw y, mm & orw y, x & orw y, (n, sp) & decw (n, sp) & xchw y, (n, sp) & orw y, \#ii & incnw y & xorw y, \#ii & caxw (y), z, x & boolw y & mad x, (n, sp), yl & xorw y, x & xorw y, mm & dnjnz yh, \#d & xorw y, (n, sp)
\end{tabular}
\end{adjustbox}
\end{center}
